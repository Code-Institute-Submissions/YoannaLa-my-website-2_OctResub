...
# Testing
## Validator testing
* HTML - 3 errors when code pass the W3C validator, there was an issue with the “form”/”div” closing tags, I've changed the order of the form and div and the issue got fix and result in no error when put thou the W3C validator.
